...
class MovieServiceTestCase(unittest.TestCase):
    ...
    def test_playlist_by_popularity(self, mock_show_movies, mock_classify_by_popularity):
    ...
    @patch.object(MoviePlaylist, 'show_movies')
    def test_playlist_by_similar_movies(self, mock_show_movies, mock_classify_by_similar_movies):
        movie_service = MovieService()
        genre = 'Action'
        actor = 'Keanu Reeves'
